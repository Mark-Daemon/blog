...
You can adjust what colours are applied by layer, as well as how many different colours are used.  
I find the approach works well with either an image with a good range of tones or by applying a mosaic effect
