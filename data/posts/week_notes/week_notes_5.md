...
I found some podcasts I may enjoy but didn't get started. I am planning to listen to the following:
* **Data Skeptic** for the stats fix.
* **EconTalk** to help me dive into Economics.
* **The Rest is History** to cover some History. It keeps getting recommended to me, so I'll give it a try.
...
For the electronics project, I have my eyes on making some [GUN4IR](https://www.gun4ir.com/) guns for 
...
I have the next week off. During which I plan on continuing to tidy the house, fulfilling some 3d print 
requests, and getting started with the KStan (Kotlin Stan bridge) project. 